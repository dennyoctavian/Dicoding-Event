...
import com.dennyoctavian.dicodingevent.databinding.FragmentSettingBinding
...
class SettingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.darkModeSwitch.isChecked = Helper.getIsDarkMode(requireContext())
        binding.darkModeSwitch.setOnClickListener {
            val isDarkModeEnabled = binding.darkModeSwitch.isChecked
            Helper.setIsDarkMode(requireContext(), isDarkModeEnabled)
        }
        return binding.root
    }
